...
def aprobar_confirmacion(request, calibracion_id):
    ...
    try:
        ...
        # Regenerar PDF con información de aprobación
        try:
...
def aprobar_intervalos(request, calibracion_id):
    ...
    try:
        ...
        try:
            ...
            equipo = calibracion.equipo
            datos_intervalos = calibracion.intervalos_calibracion_datos or {}
...
def aprobar_comprobacion(request, comprobacion_id):
    ...
    try:
        ...
        try:
            ...
            datos_comprobacion = comprobacion.datos_comprobacion or {}
