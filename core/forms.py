...
class CustomUserCreationForm(UserCreationForm):
    class Meta(UserCreationForm.Meta):
        model = CustomUser
        fields = UserCreationForm.Meta.fields + ('email', 'first_name', 'last_name', 'empresa', 'is_staff', 'is_superuser',)
        widgets = {
...
# Eliminados: ProveedorCalibracionForm, ProveedorMantenimientoForm, ProveedorComprobacionForm
# Si solo vas a usar el modelo Proveedor general, estos formularios son redundantes y se eliminan para limpiar el código.
...
class CalibracionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'confirmacion_metrologica_pdf', 'intervalos_calibracion_pdf',
            'observaciones'
        ]
        widgets = {
            ...
            'intervalos_calibracion_pdf': ClearableFileInput(attrs={'class': 'form-input-file'}),
            'observaciones': forms.Textarea(attrs={'class': 'form-textarea', 'rows': 3}),
        }
