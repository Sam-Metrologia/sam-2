...
(function() {
    ...
    // Cada paso: { stepNum, id, title, text, selector, fallbackSelector,
    //              position, navigateTo, isModal }
    // =========================================================================
    function obtenerTodosLosPasos() {
        return [
            ...
            { stepNum: 7, pagina: 'equipos', id: 'editar-formato', title: 'Formato de Empresa',
              ...
              text: 'En \'Editar Formato\' puedes ver y modificar la codificaci\u00f3n de los formatos de tu empresa: logos, c\u00f3digos de documentos y estructura de reportes.' },
            ...
            { stepNum: 17, pagina: 'prestamos', id: 'prestamos', title: 'Control de Pr\u00e9stamos',
              selector: 'h1', fallback: '.page-title', position: 'bottom',
              text: 'Control de Pr\u00e9stamos: registra cuando un equipo sale del laboratorio. Puedes hacer seguimiento de qui\u00e9n lo tiene, cu\u00e1ndo debe devolverlo, y recibir alertas de pr\u00e9stamos vencidos.',
            ...
            { stepNum: 18, pagina: 'calendario', id: 'calendario', title: 'Calendario',
              ...
              text: 'El Calendario muestra todas tus actividades programadas: calibraciones, mantenimientos y comprobaciones. Puedes filtrar por tipo, responsable, y exportar a iCal para sincronizar con Google Calendar o Outlook.',
            ...
            { stepNum: 19, pagina: 'aprobaciones', id: 'aprobaciones', title: 'Flujo de Aprobaciones',
              selector: 'h1', fallback: '.page-title', position: 'bottom',
              text: 'Flujo de Aprobaciones: cuando un t\u00e9cnico genera un documento con los formatos de la plataforma (confirmaci\u00f3n, intervalos, comprobaci\u00f3n), el administrador o gerente debe revisarlo y aprobarlo o rechazarlo antes de que sea oficial.',
              navigateTo: '/core/informes/' },

            // --- INFORMES (paso 20) ---
            { stepNum: 20, pagina: 'informes', id: 'informes', title: 'Informes y Reportes',
              selector: 'h1', fallback: '.page-title', position: 'bottom',
              text: 'Desde Informes generas documentos profesionales: Hojas de Vida de equipos en PDF, reportes de vencimientos, exportar listados a Excel, y descargar paquetes ZIP con toda la documentaci\u00f3n.',
