...
urlpatterns = [
    ...
    path('pagos/guardar-tarjeta/', views.guardar_tarjeta_autopago, name='guardar_tarjeta_autopago'),
    ...
    path('password-reset/hecho/', auth_views.PasswordResetDoneView.as_view(
    ...
    path('prestamos/<int:pk>/editar/', prestamos.editar_prestamo, name='editar_prestamo'),
    path('prestamos/<int:pk>/cancelar/', prestamos.cancelar_prestamo, name='cancelar_prestamo'),
    path('prestamos/<int:pk>/devolver/', prestamos.devolver_equipo, name='devolver_equipo'),
    path('prestamos/grupo/<int:prestamo_pk>/editar/', prestamos.editar_grupo_prestamos, name='editar_grupo_prestamos'),
    path('prestamos/grupo/<int:prestamo_pk>/devolver-todos/', prestamos.devolver_todos, name='devolver_todos'),
