...
MIDDLEWARE = [
    ...
    'core.middleware.SessionActivityMiddleware',  # Auto-logout inteligente (NUEVO 2025-11-19)
    'core.middleware.TerminosCondicionesMiddleware',  # Verificación de términos y condiciones
