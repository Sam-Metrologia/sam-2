    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo_empresa', models.ImageField(blank=True, null=True, upload_to=core.models.get_empresa_logo_upload_path)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['nombre'],
                'permissions': [('can_view_proveedorcalibracion', 'Can view proveedor calibracion'), ('can_add_proveedorcalibracion', 'Can add proveedor calibracion'), ('can_change_proveedorcalibracion', 'Can change proveedor calibracion'), ('can_delete_proveedorcalibracion', 'Can delete proveedor calibracion')],
            },
        ),
        migrations.CreateModel(
            name='ProveedorComprobacion',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=200, unique=True)),
                ('contacto', models.CharField(blank=True, max_length=100, null=True)),
            ...
            options={
                ...
                'ordering': ['nombre'],
                'permissions': [('can_view_proveedorcomprobacion', 'Can view proveedor comprobacion'), ('can_add_proveedorcomprobacion', 'Can add proveedor comprobacion'), ('can_change_proveedorcomprobacion', 'Can change proveedor comprobacion'), ('can_delete_proveedorcomprobacion', 'Can delete proveedor comprobacion')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['nombre'],
                'permissions': [('can_view_proveedormantenimiento', 'Can view proveedor mantenimiento'), ('can_add_proveedormantenimiento', 'Can add proveedor mantenimiento'), ('can_change_proveedormantenimiento', 'Can change proveedor mantenimiento'), ('can_delete_proveedormantenimiento', 'Can delete proveedor mantenimiento')],
            },
        ),
        migrations.CreateModel(
            name='Ubicacion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error_maximo_permisible', models.DecimalField(blank=True, decimal_places=5, max_digits=10, null=True, verbose_name='Error Máximo Permisible')),
                ...
                ('ubicacion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.ubicacion', verbose_name='Ubicación')),
            ],
            options={
                'verbose_name': 'Equipo',
